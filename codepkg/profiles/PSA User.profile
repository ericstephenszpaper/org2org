...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <applicationVisibilities>
        <application>Grievances_Appeals</application>
    ...
    <applicationVisibilities>
        <application>Medical_Records</application>
        <default>false</default>
        <visible>true</visible>
    </applicationVisibilities>
    <applicationVisibilities>
        <application>Patient_Assistance</application>
        <default>false</default>
        <visible>true</visible>
    </applicationVisibilities>
    <applicationVisibilities>
        <application>Physician_Order</application>
        <default>false</default>
        <visible>true</visible>
    </applicationVisibilities>
    <applicationVisibilities>
        <application>Prior_Authorization</application>
        <default>false</default>
        <visible>true</visible>
    </applicationVisibilities>
    <applicationVisibilities>
        <application>Referrals</application>
        <default>false</default>
        <visible>true</visible>
    </applicationVisibilities>
    <custom>true</custom>
    ...
    <layoutAssignments>
        <layout>Case-Enrollment Layout</layout>
        <recordType>Case.Enrollment</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Case-Grievance %26 Appeals Layout</layout>
        <recordType>Case.Grievance_Appeals</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Case-Lab Results Layout</layout>
        <recordType>Case.Lab_Results</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Case-Medical Records Layout</layout>
        <recordType>Case.Medical_Records</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Case-Order Entry Layout</layout>
        <recordType>Case.Order_Entry</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Case-Physician Order Layout</layout>
        <recordType>Case.Physician_Order</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Case-Referrals Layout</layout>
        <recordType>Case.Referrals</recordType>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>PersonAccount-Patient Person Account Layout</layout>
    ...
    <layoutAssignments>
        <layout>PersonAccount-Provider Person Account Layout</layout>
