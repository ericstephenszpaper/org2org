...
HealthCloudGA__Account__r.Ordering_Provider__r.Fax</description>
    ...
    <rules>
        ...
        <formula>AND( NOT(ISBLANK( Order__c )), NOT( ISBLANK(Order__r.Account.Ordering_Provider__r.Fax) ), NOT( INCLUDES(Order__r.Account.Ordering_Provider__r.Fax_Opt_Out__c, &quot;Patient Results&quot;) ), NOT( INCLUDES(Order__r.Account.Ordering_Provider__r.Fax_Opt_Out__c, &quot;All&quot;) ) )</formula>
