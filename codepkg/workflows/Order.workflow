...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        ...
        <formula>AND( ISPICKVAL(Source__c, &quot;Fax&quot;), NOT( ISBLANK(Account.Ordering_Provider__r.Fax) ), NOT( ISBLANK(Account.PersonContact.Birth_Date__c) ), NOT( INCLUDES(Account.Ordering_Provider__r.Fax_Opt_Out__c , &quot;Order Confirmation&quot;) ), NOT( INCLUDES(Account.Ordering_Provider__r.Fax_Opt_Out__c , &quot;All&quot;) ) )</formula>
